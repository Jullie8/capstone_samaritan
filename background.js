...
//DO NOT MESS WITH THIS CODE - It is the real code that works on one site//
...
chrome.tabs.onUpdated.addListener(function(tabId, changeInfo, tab) {
    ...
    else if (~tab.url.indexOf("https://www.buzzfeed.com/?utm_term=.yklm4B0ja#.qe119zDBx")) {
        chrome.pageAction.show(tabId);
    }
    ...
    else if (~tab.url.indexOf("https://www.nationalgeographic.com/")) {
        chrome.pageAction.show(tabId);
    }
